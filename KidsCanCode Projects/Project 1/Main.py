...
meteor_images = []
meteor_list = ["meteor_big.png", "meteor_small.png", "meteor_med.png"]
...
while running:
    ...
    for hit in hits:
        ...
        if player.shield <= 0:
            ...
            player.lives -= 1
            player.shield = 100
    # checkk to see if the player hit a powerup
    ...
    # if the player died and the explosion has finished playing then end the game
